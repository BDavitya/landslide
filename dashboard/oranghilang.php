...
<body class="d-flex">
    ...
    <div class="container" style="margin-left:150px">
        <div class="my-5">
            ...
            <h1><b>SEMUA ORANG HILANG</b></h1>
            <p class="text-body-secondary">Fitur ini menampilkan, menambahkan, mengedit, dan menghapus semua orang
                hilang yang
                terdata di sistem informasi Tanah Longsor.</p>
            <a href="addHilang.php" type="button" class="btn btn-info">Tambahkan Kasus Baru</a>
            ...
            <!-- <div class="modal fade" id="addClass" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered ">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5">Tambahkan Berita Baru</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form method="POST" action="addNews.php">
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md form-floating mb-3">
                                            <input required type="text" class="form-control" id="coach" name="isi"
                                                placeholder="Type Class Coach">
                                            <label for="coach">Isi Berita</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <table class="table table-striped table-hover display data">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="text-align: center;">Ciri</th>
                            <th scope="col" style="text-align: center;">Sejak</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        include ("connect.php");
                        $sql1 = "select * from oranghilang";
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="vertical-align: middle;"><?= $data['ciri'] ?></td>
                            <td style="vertical-align: middle;"><?= $data['sejak'] ?></td>
                            <!-- <td style="vertical-align: middle;"><?= $data['img'] ?></td> -->
                            <td style="vertical-align: middle; text-align: center;">
                                <a href="editHilang.php?id=<?= $data['id'] ?>" type="button" class="btn btn-warning"
                                    data-bs-toggle="modal" data-bs-target="#editClasses<?= $data['id'] ?>">
                                    <i class="fa fa-pencil-square-o" style="font-size: 30px;"></i>
                                </a>
                                <a href="deleteHilang.php?id=<?= $data['id'] ?>" type="button" class="btn btn-danger"
                                    data-bs-toggle="modal" data-bs-target="#deleteClasses<?= $data['id'] ?>">
