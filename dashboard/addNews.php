...
if (isset($_POST['add'])) {
    ...
    $date = $_POST['date'];
    $isi = $_POST['isi'];
    $sql = "INSERT INTO berita (judul, tanggal, artikel) VALUES ('$name', '$date', '$isi')";
...
<body class="d-flex">
    ...
    <div class="container" style="margin-left:150px">
        <div class="my-5">
            ...
            <h1><b>TAMBAH BERITA</b></h1>
            <p class="text-body-secondary">Fitur ini menambahkan berita yang di sistem informasi Tanah Longsor.</p>
