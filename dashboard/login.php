...
<head>
    ...
    <title>Login - Dasboard Landslide</title>
            ...
            <div class="user_card">
                <div class="d-flex justify-content-center">
                    <div class="brand_logo_container">
                        <img src="../assets/image/landslide.png" class="brand_logo" alt="Logo">
                    </div>
                </div>
                    ...
                    <form action="signin.php" method="POST">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control input_user" id="username" name="username"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="form-floating">
                                <input type="password" class="form-control input_pass" id="password" name="password"
