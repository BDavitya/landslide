...
<head>
    ...
    <title>Membership - Dasboard Tanah Longsor</title>
    <link rel="icon" href="../assets/image/favicon.png" type="image/svg+xml">
...
<body class="d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 bg-body-tertiary px-2" style="height: 100vh; position:fixed;">
        <div class="m-2 mt-4">
            <img src="../assets/image/dasboard/logo.svg" alt="Logo Berbinar Insightful Indonesia"
